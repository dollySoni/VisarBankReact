  ...
  const logOut = () => {
    ...
    return (
        ...
        <div className="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <h1 className="navbar-brand brand-logo me-5 text-white">Viser Bank</h1>
          <h2 className="navbar-brand brand-logo-mini text-white">Bank</h2>
        </div>
              ...
              <div className="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="messageDropdown">
                ...
                <a className="dropdown-item" href="">
                  <div className="item-thumbnail">
                    <img src="imagesF/faces/face4.jpg" alt="imageF" className="profile-pic" />
                  </div>
